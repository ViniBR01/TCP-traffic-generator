...
void open_server(void *server_options, unsigned int task_id) {
    ...
    unsigned short server_port = atoi("8080"); /* XXX Fix me */
    ...
    while (1) {
        ...
        if (select_retval == 0) {
	        ...
	        continue; /* XXX Fix-me: will return when using scheduler */
        }
